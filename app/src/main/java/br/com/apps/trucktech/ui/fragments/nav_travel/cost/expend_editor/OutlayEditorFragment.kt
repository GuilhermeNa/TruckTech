...
class OutlayEditorFragment : BaseFragmentWithToolbar() {

    private var _binding: FragmentExpendEditorBinding? = null
    private val binding get() = _binding!!

    private val args: OutlayEditorFragmentArgs by navArgs()
    ...
    private val viewModel: OutlayEditorViewModel by viewModel { parametersOf(vmData) }
