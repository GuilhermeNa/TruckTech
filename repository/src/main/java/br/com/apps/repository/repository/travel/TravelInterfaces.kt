...
interface TravelReadInterface {
     ...
     *
     * @param id The ID of the driver to retrieve travel records for.
     ...
     */
    suspend fun fetchTravelListByDriverIdAndIsFinished(id: String, flow: Boolean = false)
     ...
     */
    suspend fun fetchTravelListByDriverId(id: String, flow: Boolean = false)
            : LiveData<Response<List<Travel>>>
     ...
     */
    suspend fun fetchTravelById(id: String, flow: Boolean = false)
